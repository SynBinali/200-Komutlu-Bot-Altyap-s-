...
exports.run = async (client, message, args) => {
  const prefix =
    (await data.fetch(`prefix.${message.guild.id}`)) || 'd!';
    ...
    client.channels
      ...
      .send(
        new Discord.MessageEmbed()
           .setTitle(`${message.guild.name} Destek Bölümü`)
          .setFooter(`Dark AngeL`, client.user.avatarURL())
          .setColor("GREEN")
...
exports.help = {
  name: "ticket",
  description: 'Ticket Kanalı Ayarlandıysa Mesajı Gönderir!',
    usage: 'ticket'
};